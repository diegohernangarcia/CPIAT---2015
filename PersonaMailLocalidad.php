...
<html lang="es">
    ...
    <body>
        ...
        <div class="container">
            <form role="form" action="VerPersonaPorLocalidadMail.php" method="POST">
                <div class="row">
                    <div class="col-xs-2">
                    </div>
                    <div class="col-xs-8 columnasinborde">
                        <div class="form-group">
                            <h2>Ingrese Localidad a Buscar</h2>
                            <select id="datoconsulta" name="datoconsulta" class="form-control">
                                <?php
